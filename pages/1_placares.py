...
with col_visual:
    ...
    if "3D" in modo_vista:
        ...
        fig2d.update_layout(
            yaxis=dict(scaleanchor="x", scaleratio=1, visible=False, range=[-200, alto+250]), 
            xaxis=dict(visible=False, range=[-250, ancho+250]), 
            plot_bgcolor="white", paper_bgcolor="white", margin=dict(t=0, b=0, l=0, r=0), height=550
        )

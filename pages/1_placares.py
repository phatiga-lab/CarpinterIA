...
# ==============================================================================
st.set_page_config(page_title="CarpinterIA V25 - Workspace", page_icon="🗄️", layout="wide", initial_sidebar_state="expanded")
...
# 1. Declaramos el contenedor superior donde inyectaremos el render al final
visor_container = st.container()

st.markdown("---")

# 2. Fila Inferior: Controles de diseño
col_casco, col_interno = st.columns([1, 1.5], gap="large")
